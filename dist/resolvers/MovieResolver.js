...
let MovieResolver = class MovieResolver {
    async createMovie(options) {
        const movie = await Movie_1.Movie.create(options).save();
        return movie;
    }
...
__decorate([
    ...
    __param(0, (0, type_graphql_1.Arg)("options", () => MovieInput)),
...
__decorate([
    ...
    __param(1, (0, type_graphql_1.Arg)("input", () => MovieUpdateInput)),
    __metadata("design:type", Function),
